...
class ParentWatcher {
    ...
    static Behavior<String> childBehavior = Behaviors.receiveMessage(message ->
        switch (message) {
    ...
    public static Behavior<Command> create(ActorRef<String> monitor, List<ActorRef<String>> children) {
